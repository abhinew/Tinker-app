                ...
                <div>
                    ...
                    <div className="ownerCandidates">
                         {this.props.tenant[this.props.location.pathname.slice(-1)].thinking.map(url => <div className="candidateContainer">
                                                                        <img className="imgOwnerCandidate" src={this.props.owner[url].url[0]}/>
                                                                             <ul>
                    ...
                    <div className="ownerMatches">
                         <h2>You've got {this.props.tenant[this.props.location.pathname.slice(-1)].like.length} matches!</h2>
                    </div>
                    <div className="ownerCandidates">
